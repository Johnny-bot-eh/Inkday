...
const EASY: Pack[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { clue: "Night sky lantern", answer: "moon" },
  ...
  },
  {
    ...
    items: [
      ...
      { clue: "Yellow precious metal", answer: "gold" },
...
const MEDIUM: Pack[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { clue: "Wide flowing freshwater", answer: "river" },
    ],
  },
  {
    title: "Market Note",
...
const HARD: Pack[] = [
  {
    ...
    message: "mystery",
    items: [
      { clue: "Historic craft of transforming metals", answer: "alchemy" },
      ...
      { clue: "Long journey by sea or stars", answer: "voyage" },
    ],
  },
  {
    title: "Vault Phrase",
    message: "freedom",
    items: [
      { clue: "Mass of floating ice", answer: "glacier" },
      { clue: "Path a planet traces around the sun", answer: "orbit" },
      { clue: "Chronicle of the past", answer: "history" },
      { clue: "Mythic bird reborn from ash", answer: "phoenix" },
      { clue: "Temporary pause in fighting", answer: "truce" },
      { clue: "Open grassland", answer: "prairie" },
      { clue: "Deep understanding of a craft", answer: "insight" },
    ],
  },
  {
    title: "Signal Book",
