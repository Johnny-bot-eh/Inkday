...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  {
    id: "deco_starter_moss",
    title: "Moss patch",
    description: "Soft starter groundcover for the nest.",
    kind: "decoration",
    price: 0,
    free: true,
  ...
  {
    id: "deco_starter_pebble",
    title: "Smooth pebbles",
    description: "A little stone ring beside the nest.",
    kind: "decoration",
    price: 0,
    free: true,
    shopCategory: "flowers",
  ...
  {
    id: "deco_starter_fern",
    title: "Tiny fern",
    description: "A starter frond for the garden edge.",
    kind: "decoration",
    price: 0,
    free: true,
    shopCategory: "flowers",
